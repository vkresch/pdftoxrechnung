...
class Order(BaseModel):
    ...
    date: datetime.datetime = Field(description="Order date (Bestelldatum)", format="date-time")
...
class Settlement(BaseModel):
    ...
    advance_payment_date: datetime.datetime = Field(description="Date of advance payment (Vorauszahlungsdatum)", format="date-time")
...
class Item(BaseModel):
    ...
    period_start: Optional[datetime.datetime] = Field(description="Start date of period (Startdatum des Zeitraums)", format="date-time")
    period_end: Optional[datetime.datetime] = Field(description="End date of period (Enddatum des Zeitraums)", format="date-time")
...
class BillingPeriod(BaseModel):
    start_date: datetime.datetime = Field(description="Start date of billing period (Startdatum des Abrechnungszeitraums)", format="date-time")
    end_date: datetime.datetime = Field(description="End date of billing period (Enddatum des Abrechnungszeitraums)", format="date-time")
...
class Delivery(BaseModel):
    date: datetime.datetime = Field(description="Delivery date (Lieferdatum)", format="date-time")
...
class Header(BaseModel):
    ...
    issue_date_time: datetime.datetime = Field(description="Issue date of the invoice (Ausstellungsdatum der Rechnung)", format="date-time")
